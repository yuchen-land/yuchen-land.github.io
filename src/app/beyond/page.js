    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-orange-50 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 pt-32">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        ...
                                        {brand.url && brand.url !== "#" && (
                                            <a
                                                ...
                                                className="inline-flex items-center gap-1 px-3 py-1.5 bg-violet-100 hover:bg-violet-200 text-violet-600 rounded-lg text-xs font-medium transition-colors"
                                            >
                                        ...
                                        {brand.social?.instagram && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-pink-100 to-rose-100 hover:from-pink-200 hover:to-rose-200 text-pink-600 rounded-lg text-xs font-medium transition-colors"
                                            >
                                        ...
                                        {brand.social?.facebook && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-lg text-xs font-medium transition-colors"
                                            >
                                                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-24 space-y-20 animate-fade-in-up">
                    {hobbies.map((hobby) => (
