  ...
  return (
    <div className="bg-white/70 backdrop-blur-glass rounded-3xl overflow-hidden shadow-lg card-hover border-0 group flex flex-col h-full">
      ...
      <div className="relative h-56 bg-gradient-to-br from-pink-100 via-rose-100 to-orange-100 overflow-hidden flex-shrink-0">
        ...
        {project.featured && (
          <svg className="absolute top-5 right-5 w-5 h-5 text-amber-400 drop-shadow-[0_2px_4px_rgba(251,191,36,0.4)]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="flex gap-2 pt-2">
          {project.github && (
            <a
              ...
              className="flex-1 min-h-[42px] backdrop-blur-sm bg-gray-900/80 border border-gray-700/50 text-white py-2.5 px-4 rounded-xl text-sm font-medium hover:bg-gray-800 hover:border-gray-600/50 transition-all duration-300 flex items-center justify-center gap-2"
            >
          ...
          {project.demo && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 min-h-[42px] backdrop-blur-sm bg-rose-500/90 border border-rose-400/30 text-white py-2.5 px-4 rounded-xl text-sm font-medium hover:bg-rose-500 hover:border-rose-400/50 transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
          ...
          {hasDocumentation && projectSlug && (
            <Link
              ...
              className="flex-1 min-h-[42px] backdrop-blur-sm bg-white/70 border border-rose-200/60 text-rose-600 py-2.5 px-4 rounded-xl text-sm font-medium hover:bg-white/90 hover:border-rose-300/80 transition-all duration-300 flex items-center justify-center gap-1.5"
            >
              <span>More</span>
