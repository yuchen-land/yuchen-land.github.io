        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-rose-600 hover:bg-rose-50/80 transition-all duration-300"
              aria-label="Email"
              title="Email"
            >
              <svg
            ...
            <a
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-800 hover:bg-gray-100/80 transition-all duration-300"
              aria-label="GitHub"
              title="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-blue-600 hover:bg-blue-50/80 transition-all duration-300"
              aria-label="LinkedIn"
              title="LinkedIn"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-purple-600 hover:bg-purple-50/80 transition-all duration-300"
              aria-label="Resume"
